...
const NavBar = () => {
  return (
    <nav className=" navbar">
            <a className="icon" href="https://unsplash.com/" title="Unsplash Home">
                <svg width="32" height="32" >
                    <path d="M10 9V0h12v9H10zm12 5h10v18H0V14h10v9h12v-9z"><title id="unsplash-home">Unsplash Home</title></path>
                </svg>
            </a>
            <div className="buttonpart">
                <button className="buttonone" type="submit" placeholder="Search free high-resolution photos"> 
                    <svg className="svgone DFW_E nT46U VETef" width="25" height="25"  viewBox="0 0 32 32" version="1.1" aria-hidden="false">
                    ...
                    <input className="input-txt" type="search" title="search unsplash" placeholder="Search free high-resolition photos" />
                    <svg className="svgtwo" width="32" height="32"  viewBox="0 0 32 32" version="1.1" aria-hidden="false" >
            ...
            <a href="https://unsplash.com/?modal=%7B%22tag%22%3A%22Login%22%2C%22value%22%3A%7B%22tag%22%3A%22SubmitAPhoto%22%2C%22value%22%3A%7B%7D%7D%7D">
                <button className="submit-two" type="button">submit a photo</button>
            </a>
            
            <svg className="svgthree open-main" width="24" height="28"   >
