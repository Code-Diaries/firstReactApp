        <nav class=" navbar">
            ...
            <div class="buttonpart">
                <button class="buttonone" type="submit" placeholder="Search free high-resolution photos"> 
                    <svg class="svgone" width="25" height="25" class="DFW_E nT46U VETef" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
                    ...
                    <input class="input-txt" type="search" title="search unsplash" placeholder="Search free high-resolition photos">
            ...
            <svg class="svgthree" width="24" height="28" class="open-main" >
