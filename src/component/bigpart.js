  ...
  return (
    <div class="bigpart">
            <div class="textpart">
                ...
                <div class="firsth">
                    <h1 class="başlık">The internet’s source of <a href="https://unsplash.com/license">freely-usable</a> images.</h1>
                    <h1>Powered by creators everywhere.</h1>
                </div>
                <button class="bigsearch" type="submit">Search photos</button>
                <h2>Trending: 
